...
public class DoorService {
     ...
     */
    public ExteriorDoorDTO modifyExteriorDoorState(final String username, final long roomId, final long id, final boolean open, final boolean desiredState) {
    ...
    public DoorDTO modifyInteriorDoorState(final String username, final long roomId, final long id, final boolean desiredState) {
        validator.validatePermissions(username, roomId);
