        ...
        <div>
            ...
            >
                <ListItem>
                    ...
                    {
                        lights.map((light) => (
                            <ListItemText key={light.id} primary={`Light ID: ${light.id}`} secondary={`On: ${Boolean(light.lightOn).toString()}`}></ListItemText>
                        ))
                    }
                </ListItem>
                ...
                <ListItem>
                    ...
                    {
                        doors.map((door) => (
                            <ListItemText key={door.id} primary={`Door ID: ${door.id}`} secondary={`Open: ${Boolean(door.open).toString()} ${door.locked ? ("Locked:" + Boolean(door.locked).toString()) : ""}`}></ListItemText>
                        ))
                    }
                </ListItem>
                ...
                <ListItem>
                    ...
                    </ListItemAvatar>
                    {
                        houseWindows.map((houseWindow => (
                            <ListItemText key={houseWindow.id} primary={`WindowID: ${houseWindow.id}`} secondary={`Open: ${Boolean(houseWindow.open).toString()} Blocked: ${Boolean(houseWindow.blocked).toString()}`} ></ListItemText>
                        )))
                    }
                </ListItem>
            </List>
